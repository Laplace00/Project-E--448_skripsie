...
\newcommand{\nameInitial}{ DN Snyman}
\newcommand{\nameFull}{Dewaldt Neil Snyman}
\newcommand{\stNumber}{22706852}
...
\input{detaileddesign/detaileddesign}
\input{testingandcal/testingandcalibration}
